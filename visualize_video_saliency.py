...
def load_model_and_data(fold: int, num_random_samples: int = 5) -> list:
    ...
    # Use config file from saliency_maps/stgcn
    config_file = f'saliency_maps/stgcn/stgcn_fold{fold}.py'
    ...
    # Load predictions from saliency_maps/test_results
    pred_file = f'saliency_maps/test_results/fold{fold}_predictions.pkl'
...
def main():
    ...
    output_dir = Path('saliency_maps/output')
